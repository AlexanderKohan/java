package epamMethodsProgramming.part2.chapter12_JDBC.code.transaction;
...
public class SingletonEngine {
    ...
    private Connection getConnectionFrom() {
        try {
            ...
            connectionFrom = DriverManager.getConnection("jdbc:mysql://localhost:3306/testFrom", "root", "root");
